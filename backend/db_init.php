...
function db_init($mysqli)
{
    ...
    $lockFile   = $cacheDir . '/db_init.lock';
    $scriptFile = __FILE__;
    ...
    try {
        ...
        if ($res && $res->num_rows === 0) {
            $randomInitialPass = bin2hex(random_bytes(8));
            ...
            error_log("[SYCS db_init] Initial admin account created. Username: admin | Initial setup completed.");
        }
