...
<article class="release">
    <div class="release-header">
        ...
        <span class="release-title">API Integration Refactoring & Security Hardening</span>
        ...
        <div class="section">
            ...
            <ul>
                <li>
                    ...
                    <div>
                        <strong>Frontend XSS Mitigation</strong>
                        <span class="detail">
                            Hardened toast notifications and notification center by replacing <code>innerHTML</code> with safe <code>textContent</code> API.
                            This systematically prevents script injection vulnerabilities in the UI.
                        </span>
                    </div>
                </li>
                <li>
                    ...
                    <div>
                        <strong>Unified OAuth Integration Logic</strong>
                        <span class="detail">
                            Introduced <code>RetryHandler::callJsonApi</code> to centralize communication and retry logic for Google, Discord, Apple, and Outlook integrations.
                            This refactor eliminates code duplication and improves error resilience.
                        </span>
                    </div>
                </li>
            </ul>
