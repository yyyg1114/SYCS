...
<article class="release">
    <div class="release-header">
        ...
        <span class="release-title">フロントエンドAPI同期とソーシャルログインのセキュリティ強化</span>
        <span class="release-date">2026-09-17</span>
    </div>
    <div class="release-body">
        <div class="section">
...
<article class="release">
    <div class="release-header">
        ...
        <span class="release-title">APIファイルのBOM削除による不具合修正</span>
        ...
        <div class="section">
            ...
            <ul>
                <li>
                    <span class="icon">🐛</span>
                    <div>
                        <strong>PHPファイルのBOM（Byte Order Mark）削除</strong>
                        <span class="detail">バックエンドのAPIハンドラーファイルに混入していたUTF-8 BOMを削除し、予期しない空白出力やヘッダー送信エラーを防ぐよう修正しました。</span>
                    </div>
                </li>
            </ul>
        </div>
